...
Route::group(
	...
	function () use ($page, $article) {
		...
		Route::group(['middleware' => ['XSS']], function () {
			...
			Route::get('rss/{id}', 'HomeController@feed_detail_page');
			
			//added by majid molaea
			Route::get('media-albums', 'HomeController@media_albums');
			Route::get('state/{state_id}', 'HomeController@state');
			Route::get('states', 'HomeController@states');
			Route::get('section/{section_id}', 'HomeController@section');
			Route::post('refresh-state-content', 'HomeController@refresh_state_content');

			// new login and register routes with mobile
			Route::get('insert-mobile', 'UserController@insert_mobile');
			Route::post('insert-mobile', 'UserController@insert_mobile_post');
			Route::get('insert-password', 'UserController@insert_password');
			...
			Route::get('resend-code', 'UserController@resend_code');
			...
			Route::get('get-read-more-post-subcategory', 'ArticleController@getReadMorePostSubcategory');
			...
			Route::get('download-file/{name}', 'HomeController@downloadFile');
		});
