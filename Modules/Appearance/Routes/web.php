...
Route::group(
    ...
    function () {
        ...
        Route::group(['middleware' => ['loginCheck']], function () {
            ...
            //footer menu routes
            route::get('footer-menu', 'MenuItemController@footer_menu_item')->middleware('permissionCheck:menu_read');
            route::post('footer-menu-store', 'MenuItemController@footer_menu_store')->middleware('permissionCheck:menu_item_write');
            route::post('footer-menu-update', 'MenuItemController@footer_menu_update')->middleware('permissionCheck:menu_item_write');
            route::post('footer-menu-delete', 'MenuItemController@footer_menu_delete')->middleware('permissionCheck:menu_item_write');
        });
    }
);
