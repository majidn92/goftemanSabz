    ...
    function () {
        Route::prefix('setting')->group(function () {
            Route::group(['middleware' => ['loginCheck']], function () {
                ...
                //added by majid molaea for new sections
                Route::get('/sections', 'SettingController@sections')->middleware('permissionCheck:settings_write');
                Route::get('/section-create', 'SettingController@section_create')->middleware('permissionCheck:settings_write');
                Route::post('/section-store', 'SettingController@section_store')->middleware('permissionCheck:settings_write');
                Route::get('/section-edit/{id}', 'SettingController@section_edit')->middleware('permissionCheck:settings_write');
                Route::post('/section-update', 'SettingController@section_update')->middleware('permissionCheck:settings_write');

                //add sources
                Route::get('/sources', 'SettingController@source')->middleware('permissionCheck:settings_read');
                Route::get('/sources/add', 'SettingController@sourceAdd')->middleware('permissionCheck:settings_read');
                Route::post('/sources/edit', 'SettingController@sourceEdit')->middleware('permissionCheck:settings_write');
                Route::post('/sources/delete', 'SettingController@sourceDelete')->middleware('permissionCheck:settings_write');
            });
        });
    }
);
