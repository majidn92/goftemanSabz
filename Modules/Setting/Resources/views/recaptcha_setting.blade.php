                            ...
                            <div class="add-new-page  bg-white p-0 m-b-20">
                                ...
                                <nav>
                                    <div class="nav m-b-20 setting-tab" id="nav-tab" role="tablist">
                                        ...
                                        <a class="nav-item nav-link active" id="recaptcha-settings" href="{{ route('setting-recaptcha') }}" role="tab">{{ __('recaptcha_settings') }}</a>
                                    ...
                                    <div class="tab-pane fade show active" id="recaptcha_settings" role="tabpanel">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="captcha_sitekey" class="col-form-label">کلید سایت</label>
                                                <input id="captcha_sitekey" class="form-control" name="captcha_sitekey" data-role="tagsinput" value="{{ strtolower(\Config::get('app.demo_mode') == 'yes') ? '************' : settingHelper('captcha_sitekey') }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="captcha_secret" class="col-form-label">کلید مخفی</label>
                                                <input id="captcha_secret" class="form-control" name="captcha_secret" value="{{ strtolower(\Config::get('app.demo_mode') == 'yes') ? '**********' : settingHelper('captcha_secret') }}">
                                            </div>
                                        </div>
                                        <div class="row p-l-15">
                                            ...
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="captcha_visibility" id="visibility_show" value="1" {{ settingHelper('captcha_visibility') == 1 ? 'checked' : '' }} class="custom-control-input">
                                                    <span class="custom-control-label">{{ __('show') }}</span>
                                                </label>
                                            </div>
                                            <div class="col-3 col-md-3">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="captcha_visibility" id="visibility_hide" value="0" class="custom-control-input" {{ settingHelper('captcha_visibility') == 0 ? 'checked' : '' }}>
