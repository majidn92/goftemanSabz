                            ...
                            <div class="add-new-page  bg-white p-0 m-b-20">
                                ...
                                <nav>
                                    <div class="nav m-b-20 setting-tab" id="nav-tab" role="tablist">
                                        ...
                                        <a class="nav-item nav-link active" id="setting-config-cache" href="{{ route('cache') }}">{{ __('cache') }}</a>
                                        ...
                                        <div class="row p-l-15">
                                            ...
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="config_cache" id="config_cache_enable" value="enable" {{ File::exists(base_path() . '/bootstrap/cache/config.php') || File::exists(base_path() . '/bootstrap/cache/routes.php') ? 'checked' : '' }} class="custom-control-input">
                                                    <span class="custom-control-label">{{ __('enable') }}</span>
                                                </label>
                                            </div>
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="config_cache" id="config_cache_disable" value="disable" class="custom-control-input" {{ !File::exists(base_path() . '/bootstrap/cache/config.php') && !File::exists(base_path() . '/bootstrap/cache/routes.php') ? 'checked' : '' }}>
