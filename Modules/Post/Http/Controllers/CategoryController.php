...
class CategoryController extends Controller
{
    ...
    {
        Validator::make($request->all(), [
            'category_name'     => 'required|min:2|max:100|unique:categories,category_name,' . $request->category_id,
            'slug'              => 'nullable|min:2|max:300|regex:/^\S*$/u|unique:categories,slug,' . $request->category_id,
            'language'          => 'required'
        ])->validate();
