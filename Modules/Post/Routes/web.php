        ...
        Route::prefix('post')->group(function () {
            Route::group(['middleware' => ['loginCheck']], function () {
                ...
                Route::group(['middleware' => ['XSS']], function () {
                    ...
                    Route::post('/update/populare-order', 'PostController@updatePopulareOrder')->name('update-populare-order')->middleware('permissionCheck:post_write');
                    Route::post('/update/opinion-order', 'PostController@updateOpinionOrder')->name('update-opinion-order')->middleware('permissionCheck:post_write');
                    Route::post('/update/chat-room-order', 'PostController@updateChatRoomOrder')->name('update-chat-room-order')->middleware('permissionCheck:post_write');
                    Route::post('/update/person-of-day-order', 'PostController@updatePersonOfDayOrder')->name('update-person-of-day-order')->middleware('permissionCheck:post_write');
                    Route::post('/update/scheduled', 'PostController@updateScheduled')->name('update-scheduled')->middleware('permissionCheck:post_write');
                    Route::post('/update/draft', 'PostController@updateDraft')->name('update-draft')->middleware('permissionCheck:post_write');
                    ...
                    Route::get('/populare', 'PostController@popularePosts')->name('populare-posts')->middleware('permissionCheck:post_read');
                    Route::get('/opinion', 'PostController@opinionPosts')->name('opinion-posts')->middleware('permissionCheck:post_read');
                    Route::get('/person-of-day', 'PostController@personOfDayPosts')->name('person-of-day-posts')->middleware('permissionCheck:post_read');
                    Route::get('/chat-room', 'PostController@chatRoomPosts')->name('chat-room-posts')->middleware('permissionCheck:post_read');
                    Route::get('/draft', 'PostController@draftPosts')->name('draft-posts')->middleware('permissionCheck:post_read');
                    Route::get('/scheduled', 'PostController@scheduledPosts')->name('scheduled-posts')->middleware('permissionCheck:post_read');
                ...
                Route::post('/delete-all-post', 'PostController@delete_all_post')->middleware('permissionCheck:post_write');
                // added by majid molaea for change author post
                Route::post('/change-author', 'PostController@changeAuthor')->middleware('permissionCheck:change_author');
                 // added by majid molaea for delete post from ...
                Route::post('/delete-post-from', 'PostController@deletePostFrom')->middleware('permissionCheck:post_write');
            });
        });
    }
);
