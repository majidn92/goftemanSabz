...
@section('content')
    <div class="dashboard-ecommerce">
        {!! Form::open(['route' => ['update-post', 'video', $post->id], 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'edit-post-form']) !!}
            ...
            <div class="row">
                ...
                <div class="col-12">
                            ...
                            <div class="row add-new-page  bg-white p-20 pt-0 mt-2">
                                ...
                                <div class="col-sm-6 p-l-15">
                                    <label class="custom-control custom-checkbox pt-1">
                                        ...
                                        <span class="custom-control-label"></span>
                                        <label for="populare">پر بازدید</label>
                                    </label>
                                </div>
                    ...
                    <div class="row add-new-page  bg-white p-20 m-b-20 text-center">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <button type="button" id="btnVideoModal" class="btn btn-primary" data-toggle="modal" data-target=".video-modal-lg">ویدئو</button>
                                <input id="video_id" name="video_id" value="{{ $post->video_id }}" type="hidden" class="form-control video_id">
                            </div>
                            <div class="form-group">
                                <div class="form-group text-center">
                                    <video id="video_preview" src="{{ static_asset($post->video->original) }}" width="200" height="120" style="object-fit: fill" controls></video>
                                </div>
                            </div>
                        </div>
                        {{-- پوستر ویدئو --}}
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div id="image_library_selection">
                                    <button type="button" id="btn_image_modal" class="btn btn-primary btn-image-modal" data-id="0" data-toggle="modal" data-target=".image-modal-lg">پوستر ویدئو</button>
                            ...
                            <div class="form-group">
                                <div class="form-group text-center">
                                    @if ($post->videoThumbnail)
                                        <img src="{{ static_asset($post->videoThumbnail->videothumbnail) }}" id="video_thumb_preview" width="200" height="200" alt="image" class="img-responsive img-thumbnail image_preview">
                                    @else
                                        <img src="{{ static_asset('default-image/default-255x175.png') }}" id="video_thumb_preview" width="200" height="200" alt="image" class="img-responsive img-thumbnail image_preview">
                                    @endif
                                </div>
                            </div>
                        </div> --}}
