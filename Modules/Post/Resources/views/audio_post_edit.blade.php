...
@section('content')
    <div class="dashboard-ecommerce">
        {!! Form::open(['route' => ['update-post', 'audio', $post->id], 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'edit-post-form']) !!}
                ...
                <div class="col-12">
                    <div class="add-new-page  bg-white p-20 m-b-20">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="post_title" onkeyup="metaTitleSet()" name="title" value="{{ old('title') ?? $post->title }}" type="text" class="form-control" placeholder="تیتر را وارد نمائید">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="row p-l-15">
                            <div class="col-12">
                                ...
                                <textarea name="content" id="post_content" cols="30" rows="5" placeholder="متن خبر را وارد نمائید">{!! old('content') ?? $post->content !!}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container mb-2">
                        <div class="row add-new-page  bg-white p-20 pt-0 mt-2">
                            ...
                            <div class="col-sm-6 p-l-15 mb-3">
                                <label class="custom-control custom-checkbox pt-1">
                                    <input type="checkbox" id="featured_main_page" name="featured_main_page" class="custom-control-input" @if ($post->featured_main_page == 1 || old('featured_main_page')) checked @endif>
                                    <span class="custom-control-label"></span>
                                    <label for="featured_main_page">گالری فیلم و صوت</label>
                                </label>
                            </div>
                            <div class="col-sm-6 p-l-15">
                                @php
                    ...
                    <div class="row add-new-page  bg-white p-20 m-b-20" id="post_meta">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="meta_title" class="form-control meta" value="{{ old('meta_title') ?? $post->meta_title}}" data-type="title" name="meta_title" placeholder="متاتگ عنوان را وارد نمائید">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group" style="margin-bottom: 3px !important">
                                ...
                                <input id="post_tags" name="tags" type="text" value="{{ old('tags') ?? $post->tags}}" data-role="tagsinput" class="form-control" placeholder="برچسب ها را وارد نمائید">
                            </div>
                    ...
                    <div class="row add-new-page  bg-white p-20 m-b-20 text-center">
                        {{-- فایل صوت --}}
                        <div class="col-sm-4">
                            <div class="form-group">
                                <button type="button" id="btnAudioModal" class="btn btn-primary" data-toggle="modal" data-target=".audio-modal-lg">فایل صوتی</button>
                                <input id="audio_id" name="audio_id" value="{{ $post->audio_id }}" type="hidden" class="form-control audio_id">
                            </div>
                            <div class="form-group">
                                <div class="form-group text-center">
                                    <div style="position: relative">
                                        {{-- {{dd($post->audio)}} --}}
                                        <img src="{{ static_asset('default-image/music-100x100.png') }} " id="audio_thumb" width="200" height="200" alt="image" class="img-responsive img-thumbnail audio_preview">
                                        <audio id="audio_preview" src="{{ static_asset($post->audio->original) }}" controls></audio>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div id="image_library_selection">
                                    <button type="button" id="btn_image_modal" class="btn btn-primary btn-image-modal" data-id="0" data-toggle="modal" data-target=".image-modal-lg">پوستر صوت</button>
                                    <input id="image_id" name="image_id" value="{{ $post->image_id }}" type="hidden" class="form-control image_id">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group text-center">
                                    @if ($post->image)
                                        <img src="{{ static_asset($post->image->medium_image) }}" image-data-id='img1' id="image_preview" width="200" height="200" alt="image" class="img-responsive img-thumbnail image_preview">
                                    @else
                                        <img src="{{ static_asset('default-image/default-255x175.png') }}" image-data-id='img1' id="image_preview" width="200" height="200" alt="image" class="img-responsive img-thumbnail image_preview">
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- <div class="col-sm-4">
                            <div class="form-group text-center">
                                ...
                                <input id="audio_thumbnail_id" name="audio_thumbnail_id" type="hidden" class="form-control image_id">
                            </div>
                            <div class="form-group">
                                <div class="form-group text-center">
                                    <img src="{{ static_asset('default-image/default-100x100.png') }} " id="audio_thumb_preview" width="200" height="200" alt="image" class="img-responsive img-thumbnail image_preview">
                                </div>
                            </div>
                        </div> --}}
                    </div>
