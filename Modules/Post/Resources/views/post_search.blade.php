                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        {{-- <div class="item-table-filter">
                                            ...
                                            <select class="form-control" name="language">
                                                ...
                                                @foreach ($activeLang as $lang)
                                                    <option @if ($search_query->language == $lang->code) selected @endif value="{{ $lang->code }}">{{ $lang->name }} </option>
                                                @endforeach
                                            </select>
                                        </div> --}}
                                        ...
                                        <div class="item-table-filter">
                                            ...
                                            <select name="post_type" class="form-control">
                                                <option value="">{{ __('all') }}</option>
                                                <option @if ($search_query->post_type == 'article') selected @endif value="article">{{ __('article') }}</option>
                                                <option @if ($search_query->post_type == 'video') selected @endif value="video">{{ __('video') }}</option>
                                                <option @if ($search_query->post_type == 'audio') selected @endif value="audio">{{ __('audio') }}</option>
                                                <option @if ($search_query->post_type == 'rss') selected @endif value="rss">{{ __('RSS') }}</option>
                                            </select>
                                        </div>
                                        ...
                                        {{-- <div class="item-table-filter">
                                            ...
                                            <select class="form-control dynamic" id="category_id" name="category_id" data-dependent="sub_category_id">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option @if ($search_query->category_id == $category->id) selected @endif value="{{ $category->id }}">{{ $category->category_name }}</option>
                                                @endforeach
                                            </select>
                                        </div> --}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control dynamic" id="sub_category_id" name="sub_category_id">
                                                    ...
                                                    @foreach ($subCategories as $subCategory)
                                                        <option @if ($search_query->sub_category_id == $subCategory->id) selected @endif value="{{ $subCategory->id }}">{{ $subCategory->sub_category_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div> --}}
                                        ...
                                        <div class="item-table-filter">
                                            <p class="text-muted"><small>جستجو</small></p>
                                            <input name="search_key" value="{{ $search_query->search_key }}" class="form-control" placeholder="جستجو" type="search">
                                        </div>
                                                ...
                                                @if (Sentinel::getUser()->hasAccess(['post_write']) || Sentinel::getUser()->hasAccess(['post_delete']))
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu options-dropdown" style="left:40px !important;">
                                                                @if (Sentinel::getUser()->hasAccess(['post_write']))
                                                                    <li>
