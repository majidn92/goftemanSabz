...
@section('content')
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            {!! Form::open(['route' => ['save-new-post', 'audio'], 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'create-post-form']) !!}
            <input type="hidden" id="images" value="{{ $countImage }}">
            <input type="hidden" id="audios" value="{{ $countVideo }}">
                            ...
                            @if (Sentinel::getUser()->hasAccess(['post_options']))
                                <div class="row add-new-page  bg-white p-20 pt-0 mt-2">
                                    ...
                                    <div class="col-sm-6 p-l-15 mb-3">
                                        <label class="custom-control custom-checkbox pt-1">
                                            <input type="checkbox" id="featured_main_page" name="featured_main_page" class="custom-control-input" @if (old('featured_main_page')) checked @endif>
                                            <span class="custom-control-label"></span>
                ...
                <div class="row add-new-page  bg-white p-20 m-b-20" id="post_meta">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control meta" id="meta_description" value="{{ old('meta_description') }}" name="meta_description" data-type="description" rows="3" placeholder="متاتگ توضیحات را وارد نمائید"></textarea>
                            </p>
                        </div>
                    </div>
                ...
                <div class="row add-new-page  bg-white p-20 m-b-20 text-center">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input id="audio_id" name="audio_id" type="hidden" class="form-control audio_id">
                        </div>
                        <div class="form-group">
