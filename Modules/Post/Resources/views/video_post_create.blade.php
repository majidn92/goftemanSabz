...
@section('content')
    <div class="dashboard-ecommerce">
        {!! Form::open(['route' => ['save-new-post', 'video'], 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'create-post-form']) !!}
        ...
        <div class="row add-new-page  bg-white p-20 m-b-20 text-center">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input id="video_id" name="video_id" type="text" class="form-control video_id" style="display: none">
                </div>
                <div class="form-group">
                    <div class="form-group text-center">
                        <video id="video_preview" poster="{{ static_asset('default-image/default-video-100x100.png') }}" width="200" height="120" style="object-fit: fill" controls></video>
                    </div>
                </div>
            </div>
            {{-- پوستر ویدئو --}}
