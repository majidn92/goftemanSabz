            ...
            <div class="row clearfix">
                ...
                <div class="col-8">
                    <div class="add-new-page  bg-white p-20 m-b-20">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="page-slug" class="col-form-label"><b>{{ __('slug') }}</b></label>
                ...
                <div class="col-4">
                    <div class="add-new-page  bg-white p-20 m-b-20">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="template" class="col-form-label">نوار کناری</label>
                                <select name="template" id="template" class="form-control">
                                    <option value="1">{{ __('without_sidebar') }}</option>
                                    <option value="2">با نوار کناری</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="add-new-page  bg-white p-20 m-b-20">
                        ...
                        {{-- un display with majid molaea --}}
                        {{-- <div class="row p-l-15">
                            <div class="col-12 col-md-4">
                                <div class="form-title">
                                    <label for="location">موقعیت نمایش</label>
                                </div>
                            </div>
                            <div class="col-3 col-md-2">
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="location" id="menu_location_top" value="top" class="custom-control-input">
                                    <span class="custom-control-label">{{ __('top_menu') }}</span>
                                </label>
                            </div>
                            <div class="col-3 col-md-2">
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="location" id="menu_location_main" value="mainmenu" class="custom-control-input">
                                    <span class="custom-control-label">{{ __('main_menu') }}</span>
                                </label>
                            </div>
                            <div class="col-3 col-md-2">
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="location" id="menu_location_footer" value="footer" class="custom-control-input">
                                    <span class="custom-control-label">{{ __('footer') }}</span>
                                </label>
                            </div>
                            <div class="col-3 col-md-2">
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="location" id="menu_location_none" value="none" class="custom-control-input">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group form-float form-group-sm">
                                    <button type="submit" class="btn btn-primary float-right m-t-20"><i class="mdi mdi-plus"></i> {{ __('add_page') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
