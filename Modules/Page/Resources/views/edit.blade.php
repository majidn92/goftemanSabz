                    ...
                    <div class="add-new-page  bg-white p-20 m-b-20">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group text-center">
                                @if(isFileExist($page->image, $result = @$page->image->thumbnail))
                                    <img src=" {{basePath($page->image)}}/{{ $result }} "
                        ...
                        <div class="col-sm-12">
                            <div class="form-group text-center">
                                <button type="button" id="btn_image_modal" class="btn btn-primary btn-image-modal"
                                        data-id="1" data-toggle="modal" data-target=".image-modal-lg"> {{__('add image')}}
                                </button>
