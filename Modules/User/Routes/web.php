    ...
    function()
    {
        Route::prefix('user')->group(function() {
            ...
            Route::group(['middleware'=>['loginCheck', "XSS"]],function(){
                ...
                //added by majid molaea for other permission section
                Route::get('/other-permissions', 'RolesPermissionsController@otherPermissions')->name('other-permissions')->middleware('permissionCheck:permission_read');
