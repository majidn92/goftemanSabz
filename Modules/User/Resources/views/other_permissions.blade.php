                                                ...
                                                @foreach ($roles as $role)
                                                    ...
                                                    <td>
                                                        ...
                                                        <label class="custom-control custom-checkbox">
                                                            <input type="checkbox" onclick="change_item('{{ $permission->name }}','{{ $role->id }}')" @if (array_key_exists($permission->name, $rolePermissions)) checked @endif name="post" class="custom-control-input">
