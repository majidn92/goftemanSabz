...
class RolesPermissionsController extends Controller
{
    ...
    public function permissions()
    {
        ...
        $permissions = Permission::where('other_permissions', 0)->select('name', 'name_fa')->groupBy('name')->paginate(10);
    ...
    public function otherPermissions()
    {
        $roles = Role::withoutSuperadmin()->get();
        $permissions = Permission::where('other_permissions', 1)->select('name', 'name_fa')->groupBy('name')->paginate(10);
        $noOfRole = $roles->count();

        return view('user::other_permissions', compact('permissions', 'roles', 'noOfRole'));
    }
}
