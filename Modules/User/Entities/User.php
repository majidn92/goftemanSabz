...
class User extends EloquentUser implements JWTSubject
{
    ...
    public function image(){
        return $this->hasMany('Modules\Gallery\Entities\Image');
    }

    public function audio(){
        return $this->hasMany('Modules\Gallery\Entities\Audio');
    }

    public function video(){
        return $this->hasMany('Modules\Gallery\Entities\Video');
    }
