                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-8">
                            <form class="author-form" name="author-form" method="post" action="{{ route('video.update.video') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input id="rank" name="rank" value="{{ $video->rank }}" type="number" min="1" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control dynamic-album-tab" id="category_id" name="category_id" video>
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}" @if ($category->id == $video->video_category_id) selected @endif>{{ $category->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control dynamic-album-tab" id="section_id" name="section_id">
                                                    ...
                                                    @foreach ($sections as $section)
                                                        <option value="{{ $section->id }}" @if ($section->id == $video->section_id) selected @endif>{{ $section->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id="image-slug" name="title" value="{{ $video->title }}" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 offset-6 p-l-5 my-3">
                                            <label class="custom-control custom-checkbox pt-1">
                                                <input type="checkbox" id="featured" name="featured" class="custom-control-input" @if ($video->featured) checked @endif>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <img id="coverImg" src="{{ static_asset($video->cover) }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="field">
                                            ...
                                            <video controls width="80%">
                                                <source id="video_here" src="{{static_asset($video->path)}}">
                                    ...
                                    <div class="row">
                                        <div class="col-12 m-t-20">
                                            <div class="form-group form-float form-group-sm text-right">
                                                <button type="submit" name="btnsubmit" class="btn btn-primary"><i class="m-l-10 fa fa-save"></i>{{ __('save') }}</button>
                                            </div>
                                        </div>
                                    </div>
