...
class GalleryController extends Controller
{
    ...
    {
        // dd(settingHelper('default_storage'));
    ...
    public function fetchImage(Request $request)
    {
        ...
        // todo
        // $images = Sentinel::getUser()->image()->orderBy('id', 'DESC')->paginate(24);
    ...
    public function fetchVideo(Request $request)
    {
        ...
        //todo
        // $videos = Sentinel::getUser()->video()->orderBy('id', 'DESC')->paginate(24);
    ...
    {
        //todo
        // $audios = Sentinel::getUser()->audio()->orderBy('id', 'DESC')->paginate(24);
        $audios = Audio::orderBy('id', 'DESC')->paginate(24);

        return view('gallery::ajax-audios', compact('audios'));
    }

    public function fetch_video_selected($id)
    {
        $video = Video::find($id);
        $url = static_asset($video->original);
        return $url;
    }

    public function fetch_audio_selected($id)
    {
        $audio = Audio::find($id);
        $url = static_asset($audio->original);
        return $url;
    }

    public function fetchEditorImage($id)
    {
        $image = galleryImage::find($id);
        return $image->big_image_two;
    }
}
