                        ...
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="language" id="language">
                                                @foreach ($activeLang as $lang)
                                                    <option @if ($album->language == $lang->code) Selected @endif value="{{ $lang->code }}">{{ $lang->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="section-id">بخش یا صنعت*</label>
                                            <select class="form-control" name="section_id" id="section-id">
                                                @foreach ($sections as $section)
                                                    <option @if ($section->id == $album->section_id) selected @endif value="{{ $section->id }}">{{ $section->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="name" class="col-form-label">{{ __('album_name') }}
                                                *</label>
                                            <input id="name" name="name" value="{{ $album->name }}" type="text" class="form-control">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input id="album-slug" name="slug" value="{{ $album->slug }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                    {{-- <div class="col-sm-12">
                                    <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="album-desc" class="col-form-label"><b>{{ __('description') }}</b>
                                                ({{ __('meta_tag') }})</label>
                                            <input id="album-desc" name="meta_description" value="{{ $album->meta_description }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="album-keywords" class="col-form-label"><b>{{ __('keywords') }}</b> ({{ __('meta_tag') }})</label>
                                            <input id="album-keywords" name="meta_keywords" value="{{ $album->meta_keywords }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
