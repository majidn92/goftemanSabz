                        ...
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="section">بخش یا صنعت *</label>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="album-desc" class="col-form-label"><b>{{ __('description') }}</b>
                                                ({{ __('meta_tag') }})</label>
                                            <input id="album-desc" name="meta_description" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="album-keywords" class="col-form-label"><b>{{ __('keywords') }}</b> ({{ __('meta_tag') }})</label>
                                            <input id="album-keywords" name="meta_keywords" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="field" align="left">
                                            <label for="images" class="upload-file-btn btn btn-primary"><i class="fa fa-folder input-file" aria-hidden="true"></i> {{ __('select_cover_image') }} *
                                            </label><br>
                                ...
                                <div class="row">
                                    <div class="col-12 m-t-20">
                                        <div class="form-group form-float form-group-sm text-right">
                                            <button type="submit" name="btnsubmit" class="btn btn-primary pull-right"><i class="m-l-10 mdi mdi-plus"></i>{{ __('add_album') }}</button>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tr role="row" class="odd" id="row_{{ $album->id }}">
                                                    ...
                                                    <td>
                                                        @if (isFileExist(@$album, $result = @$album->thumbnail))
                                                            <img src=" {{ basePath($album) }}/{{ $result }} " data-src="{{ basePath($album) }}/{{ $result }}" alt="image" width="100" height="70">
                                                        @else
                                                            <img src="{{ static_asset('default-image/default-100x100.png') }} " alt="image" width="100" height="70">
                                                        @endif
                                                    </td>
                                                    <td>{{ $album->name }}</td>
                                                    <td>{{ __($album->section->name) }}</td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu options-dropdown">
                                                                    @if (Sentinel::getUser()->hasAccess(['album_write']))
                                                                        <li>
                                                                            <a href="{{ route('edit-album', ['id' => $album->id]) }}"><i class="fa fa-edit option-icon"></i>{{ __('edit') }}
                                                                            </a>
                                                                        </li>
                                                                    @endif
                                                                    @if (Sentinel::getUser()->hasAccess(['album_delete']))
                                                                        <li>
                                                                            <a href="javascript:void(0)" onclick="delete_item('albums','{{ $album->id }}')"><i class="fa fa-trash option-icon"></i>{{ __('delete') }}
                                                                            </a>
                                                                        </li>
                                                                    @endif
                                                                </ul>
