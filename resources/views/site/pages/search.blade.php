                            ...
                            <div class="section-content search-content">
                                            ...
                                            <div class="sg-post medium-post-style-1">
                                                ...
                                                <div class="entry-content align-self-center">
                                                    <h3 class="entry-title">
                                                        <a href="{{ route('article.detail', ['id' => $post->slug]) }}">{!! \Illuminate\Support\Str::limit($post->title, 95) !!}</a>
                                                    </h3>
                                                    ...
                                                    <p>{{ \Illuminate\Support\Str::limit($post->sub_title, 155) }}</p>
                                                </div>
                                            </div>
                                        @endforeach
                                    @endif
                                ...
                                @if ($posts->count() != 0)
                                    ...
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="row">
                                            <button class="btn-load-more {{ $totalPostCount > 6 ? '' : 'd-none' }}" id="btn-load-more-search">
                                                {{ __('load_more') }}
                                            </button>
