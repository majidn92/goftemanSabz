                        ...
                        <div class="sg-section">
                            <div class="section-content">
                                <div class="latest-post-area">
                                    <div>
                                        <h2 style="color: var(--primary-color);font-weight: 600;margin-top: 15px">
                                            برچسب : 
                                            <span> {{ $result }}</span>
                                        </h2>
                                    </div>
                                            ...
                                            <div class="entry-content align-self-center">
                                                ...
                                                {{-- <div class="entry-meta mb-2">
                                                    <ul class="global-list">
                                                        ...
                                                        <li><a href="{{ route('article.date', date('Y-m-d', strtotime($post->updated_at))) }}"> {{ miladi_to_jalali($post->updated_at, 1) }}</a></li>
                                                    </ul>
                                                </div> --}}
