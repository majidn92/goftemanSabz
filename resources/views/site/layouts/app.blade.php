...
<head>
    ...
    <link rel="shortcut icon" href="{{ static_asset(settingHelper('favicon')) }}" type="image/png" >
    ...
    <link rel="stylesheet" href="{{ static_asset('vendor/lightboxed/lightboxed.css') }}">

    @yield('style')

    {{-- icons --}}
    <link rel="stylesheet" rel="icon" href="{{ static_asset(settingHelper('favicon')) }}">
    <link rel="stylesheet" rel="apple-touch-icon" sizes="144x144" href="{{ static_asset('site/images/ico/apple-touch-icon-precomposed.png') }}">
    <link rel="stylesheet" rel="apple-touch-icon" sizes="114x114" href="{{ static_asset('site/images/ico/apple-touch-icon-114-precomposed.png') }}">
    <link rel="stylesheet" rel="apple-touch-icon" sizes="72x72" href="{{ static_asset('site/images/ico/apple-touch-icon-72-precomposed.png') }}">
    <link rel="stylesheet" rel="apple-touch-icon" sizes="57x57" href="{{ static_asset('site/images/ico/apple-touch-icon-57-precomposed.png') }}">
    ...
    <style type="text/css">
        :root {
            ...
            --second-color: {{ data_get(activeTheme(), 'options.second_color') }};
...
<body id="front">
    ...
    <div class="scrollToTop" id="display-nothing">
        <a href="#" class="pl-0 text-center"><i class="fa fa-angle-up"></i></a>
    </div>
    ...
    <script src="{{ static_asset('vendor/lightboxed/lightboxed.js') }}"></script>
