<div class="col-lg-4">
    <div class="footer-widget">
        ...
        @foreach($content as $post)
            ...
            <div class="sg-post small-post post-style-1 row">
                <div class="entry-header col-sm-4">
                ...
                <div class="entry-content col-sm-8">
                    <h2 class="entry-title"><a href="{{ route('article.detail', [$post->slug]) }}">{{ \Illuminate\Support\Str::limit(data_get($post, 'title'), 65) }}</a></h2>
                    <div class="entry-meta">
                        <ul class="global-list">
                            <li><a href="{{ route('site.author',['id' => $post->user->id]) }}"> {{ data_get($post, 'user.first_name') }} {{ data_get($post, 'user.last_name') }}</a></li>
